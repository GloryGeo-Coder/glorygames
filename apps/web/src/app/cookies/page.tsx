...
export const metadata: Metadata = {
  ...
  description:
    "Read the WebGameArena Cookie Policy to understand how cookies and similar technologies may be used for login sessions, analytics, preferences and platform improvement.",
  alternates: {
    canonical: "/cookies",
  },
  openGraph: {
    title: "Cookie Policy | WebGameArena",
    description:
      "Learn how WebGameArena uses cookies for sessions, preferences, analytics and player experience improvements.",
...
export default function CookiePolicyPage() {
  return (
    <InfoPage
      ...
      description="This Cookie Policy explains how WebGameArena may use cookies and similar technologies to support login sessions, preferences, analytics, security and platform improvement."
      updated="18 May 2026"
      sections={[
        {
        ...
        },
        {
          ...
          body: [
            ...
            "Advertising cookies — may be introduced in future if WebGameArena adds player-friendly advertising or sponsorship features.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: "If advertising is added in future, advertising partners may use cookies or similar technologies to measure ad delivery and relevance. WebGameArena aims to keep advertising respectful, clear and appropriate for a broad audience.",
        },
        {
        ...
        {
          title: "10. Contact",
          body: "For questions about cookies or privacy on WebGameArena, please use the Contact page.",
        },
      ]}
    />
  );
