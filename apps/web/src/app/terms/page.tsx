...
export const metadata: Metadata = {
  title: "Terms of Use | GloryGames",
  description:
    "Read the GloryGames Terms of Use for rules about playing games, accounts, leaderboards, chat, content, safety and platform use.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    title: "Terms of Use | GloryGames",
    description:
      "Understand the rules and conditions for using GloryGames and playing free browser games.",
    url: "https://glorygames.co.za/terms",
    siteName: "GloryGames",
    type: "website",
    locale: "en_ZA",
  },
...
export default function TermsPage() {
  return (
    <InfoPage
      ...
      title="The rules for playing fairly on GloryGames."
      description="These Terms of Use explain how players may use GloryGames, including games, accounts, leaderboards, chat features and platform content."
      updated="18 May 2026"
      sections={[
        {
          title: "1. Acceptance of these terms",
          body: "By using GloryGames, browsing the website, creating an account, playing games or submitting scores, you agree to these Terms of Use. If you do not agree, you should stop using the platform.",
        },
        {
          title: "2. About GloryGames",
          body: "GloryGames is a browser gaming platform that provides free, mobile-first games for instant play. The platform may include game categories, leaderboards, daily challenges, chat features, player accounts and game detail pages.",
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            "GloryGames may reset, moderate or adjust leaderboards where needed to protect fair play.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: "Games may be added, updated, paused, removed or replaced over time. GloryGames does not guarantee that every game, score, leaderboard or feature will always be available without interruption.",
        },
        {
          title: "8. Intellectual property",
          body: "The GloryGames name, platform design, original text, code, game pages, layouts and platform branding belong to their respective owners. Players may not copy, resell or misuse platform content without permission.",
        },
        {
        ...
        },
        {
          ...
          body: "Future game submissions may be reviewed before publishing. GloryGames may reject, remove or request changes to submitted games if they are unsafe, unsuitable, broken, misleading or inconsistent with platform standards.",
        },
        {
        ...
        },
        {
          ...
          body: "GloryGames is provided on an as-is basis. While reasonable effort is made to keep the platform useful and safe, errors, downtime, data loss, score issues or gameplay bugs may occur.",
        },
        {
          title: "14. Changes to these terms",
          body: "These Terms of Use may be updated as GloryGames grows and new features are added. The updated date will show when changes were last made.",
        },
        {
          title: "15. Contact",
